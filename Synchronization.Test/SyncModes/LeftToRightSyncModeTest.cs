...
{
    /// <summary>
    ///This is a test class for LeftToRightSyncModeTest and is intended
    ///to contain all LeftToRightSyncModeTest Unit Tests
    ///</summary>
    [TestClass()]
    public class LeftToRightSyncModeTest : AbstractSyncTest
    {
        ...
        public void DirectoryFoundOnTargetDirectoryTest()
        {
            ...
            Assert.IsInstanceOfType(syncItem, typeof(DeleteDirectorySyncItem), "Directory should be deleted.");
        }
        ...
        public void FileFoundOnTargetDirectoryTest()
        {
            ...
            Assert.IsInstanceOfType(syncItem, typeof(DeleteFileSyncItem), "File should be deleted.");
