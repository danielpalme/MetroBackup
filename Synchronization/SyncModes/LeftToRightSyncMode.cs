...
{
    /// <summary>
    /// <see cref="ISyncMode"/> that performs synchronization from left to right.
    /// </summary>
    public class LeftToRightSyncMode : ISyncMode
    {
        /// <summary>
        ...
        public string Name
        {
            get
            {
                return Common.SyncModeType_LeftToRight;
            }
        }
        ...
        public SyncItemBase FileFoundOnTargetDirectory(string fileOnReferenceFolder, string fileOnTargetFolder)
        {
            ...
            {
                return new DeleteFileSyncItem(fileOnTargetFolder);
            }
            else
            {
                return null;
        ...
        public SyncItemBase DirectoryFoundOnTargetDirectory(string directoryInReferenceFolder, string directoryInTargetFolder)
        {
            ...
            {
                return new DeleteDirectorySyncItem(directoryInTargetFolder);
            }
            else
            {
                return null;
